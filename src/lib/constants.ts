...
export const APP_NAME = 'Techpeek AI';
...
export const LEGAL_API_BASE_URL = `${WEBUI_BASE_URL}/legalsearch/api/v1`;
export const CASE_API_BASE_URL = `${WEBUI_BASE_URL}/caseprediction/api/v1`;
