...
from apps.legalsearch.main import app as legal_app
from apps.caseprediction.main import app as case_app
...
app.mount("/legalsearch/api/v1", legal_app)
app.mount("/caseprediction/api/v1", case_app)
